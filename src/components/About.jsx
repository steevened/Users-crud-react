...
const About = () => {
  return (
    <div className='absolute top-1/2 left-1/2 w-5/6  text-center shadow-lg shadow-primary-content rounded-box  h-2/4 px-6 py-10 -translate-x-1/2 -translate-y-1/2 max-w-[512px] bg-base-100'>
